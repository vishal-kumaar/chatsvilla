  ...
  return (
    <aside
      className={`z-50 bg-[#5a4de6] dark:bg-black text-white fixed md:sticky top-0 left-0 ${
        sidebar ? "w-60 md:w-80" : "w-0 md:w-16"
      } transition-all duration-500 ease-in-out h-screen overflow-hidden`}>
      <div className="mx-3 py-7 flex flex-col gap-12 justify-between h-screen overflow-x-hidden">
        <div>
          <div className="flex items-center overflow-hidden gap-x-4 px-2.5 py-2">
            <Image
              alt="menu"
          ...
          <div
            className={`mt-12 flex flex-col gap-y-6 overflow-y-auto ${
              sidebar ? "px-3" : ""
            } overflow-x-hidden`}>
            <Link
              href="/"
